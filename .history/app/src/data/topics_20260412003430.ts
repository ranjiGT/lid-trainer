  ...
  },
  {
    ...
    details: {
      ...
      table: {
        ...
        rows: [
          { label: { de: "Legislative", en: "Legislative" }, value: { de: "Gesetzgebung (z.\u00a0B. Bundestag)", en: "Legislative power (e.g., the Bundestag)" } },
          { label: { de: "Exekutive", en: "Executive" }, value: { de: "Ausf\u00fchrende Gewalt (z.\u00a0B. Polizei)", en: "Executive power (e.g., the police)" } },
          { label: { de: "Judikative", en: "Judiciary" }, value: { de: "Rechtsprechung (z.\u00a0B. Arbeitsgericht)", en: "Judicial power (e.g., labor courts)" } },
        ],
      },
    },
  },
