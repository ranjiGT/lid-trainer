...
export const topics: Topic[] = [
  ...
  },
  {
    ...
    details: {
      ...
      gallery: [
        {
          src: "/images/topics/fraktion/bundestag.svg",
          alt: { de: "Bundestag Plenarsaal", en: "Bundestag Plenary Hall" },
          caption: { de: "Im Plenarsaal sitzen die Fraktionen in Gruppen zusammen.", en: "In the plenary hall, parliamentary groups sit together." },
        },
        {
          src: "/images/topics/fraktion/parteien.svg",
          alt: { de: "Fraktionen im Bundestag", en: "Parliamentary groups in the Bundestag" },
          caption: { de: "Abgeordnete derselben Partei bilden eine Fraktion.", en: "Members of the same party form a parliamentary group." },
        },
        {
          src: "/images/topics/fraktion/fuenf-prozent.svg",
          alt: { de: "5-Prozent-Mindestgröße", en: "5 percent minimum size" },
          caption: { de: "Eine Fraktion muss mindestens 5 % der Abgeordneten umfassen.", en: "A parliamentary group must comprise at least 5% of members." },
        },
        {
          src: "/images/topics/fraktion/ausschuss.svg",
          alt: { de: "Ausschussarbeit", en: "Committee work" },
          caption: { de: "Fraktionen engagieren sich aktiv in den Ausschüssen des Bundestags.", en: "Parliamentary groups actively participate in Bundestag committees." },
        },
      ],
    },
  },
  ...
  },
  {
    ...
    details: {
      ...
      gallery: [
        {
          src: "/images/topics/bundeskabinett/kabinett.svg",
          alt: { de: "Bundeskabinett", en: "Federal Cabinet" },
          caption: { de: "Das Bundeskabinett besteht aus dem Kanzler und den Bundesministern.", en: "The Federal Cabinet consists of the Chancellor and federal ministers." },
        },
        {
          src: "/images/topics/bundeskabinett/ernennungsprozess.svg",
          alt: { de: "Ernennungsprozess", en: "Appointment process" },
          caption: { de: "Der Bundestag wählt den Kanzler, der die Minister vorschlägt. Der Bundespräsident ernennt sie.", en: "The Bundestag elects the Chancellor, who proposes ministers. The Federal President appoints them." },
        },
        {
          src: "/images/topics/bundeskabinett/richtlinien.svg",
          alt: { de: "Richtlinienkompetenz", en: "Policy guidelines authority" },
          caption: { de: "Der Bundeskanzler bestimmt die Richtlinien der Politik (Richtlinienkompetenz).", en: "The Federal Chancellor determines policy guidelines (Richtlinienkompetenz)." },
        },
        {
          src: "/images/topics/bundeskabinett/sitzung.svg",
          alt: { de: "Kabinettssitzung", en: "Cabinet meeting" },
          caption: { de: "In der Kabinettssitzung werden Regierungsbeschlüsse gefasst.", en: "Government decisions are made in cabinet meetings." },
        },
      ],
    },
  },
  ...
  },
  {
    ...
    details: {
      gallery: [
        {
          src: "/images/topics/ehrenamt/feuerwehr.svg",
          alt: { de: "Freiwillige Feuerwehr", en: "Voluntary Fire Department" },
          caption: { de: "Die Freiwillige Feuerwehr ist eines der bekanntesten Ehrenämter in Deutschland.", en: "The voluntary fire department is one of the best-known volunteer roles in Germany." },
        },
        {
          src: "/images/topics/ehrenamt/sportverein.svg",
          alt: { de: "Sportverein", en: "Sports Club" },
          caption: { de: "Viele Sportvereine werden ehrenamtlich von Trainern und Helfern betrieben.", en: "Many sports clubs are run by volunteer coaches and helpers." },
        },
        {
          src: "/images/topics/ehrenamt/rettungsdienst.svg",
          alt: { de: "Rettungsdienst", en: "Rescue Service" },
          caption: { de: "Ehrenamtliche Helfer beim DRK und THW leisten wichtige Arbeit.", en: "Volunteers at the Red Cross and THW do important work." },
        },
        {
          src: "/images/topics/ehrenamt/elternbeirat.svg",
          alt: { de: "Elternbeirat", en: "Parent Council" },
          caption: { de: "Der Elternbeirat vertritt die Interessen der Eltern in Schulen.", en: "The parent council represents the interests of parents in schools." },
        },
      ],
      keyFacts: {
    ...
    details: {
      ...
      table: {
        ...
        rows: [
          ...
          { label: { de: "Juni 1948 \u2013 Mai 1949", en: "Jun. 1948 \u2013 May 1949" }, value: { de: "Berliner Luftbr\u00fccke \u2013 Versorgung West-Berlins durch die Westalliierten", en: "Berlin Airlift \u2013 supply of West Berlin by Western Allies" }, image: "/images/topics/wichtige-jahreszahlen/berliner-luftbruecke.jpg" },
          ...
          { label: { de: "7. Dez. 1970", en: "Dec. 7, 1970" }, value: { de: "Willy Brandts Kniefall in Warschau \u2013 Symbol der Vers\u00f6hnung (Ostpolitik)", en: "Willy Brandt\u2019s genuflection in Warsaw 1970 \u2013 symbol of reconciliation (Ostpolitik)" }, image: "/images/topics/wichtige-jahreszahlen/kniefall-denkmal.jpg" },
          ...
          { label: { de: "9. Nov. 1989", en: "Nov. 9, 1989" }, value: { de: "Fall der Berliner Mauer", en: "Fall of the Berlin Wall" }, image: "/images/topics/wichtige-jahreszahlen/mauerfall.jpg" },
          { label: { de: "18. M\u00e4rz 1990", en: "Mar. 18, 1990" }, value: { de: "Erste freie Volkskammerwahl in der DDR", en: "First free election in the GDR" } },
          ...
          { label: { de: "2002", en: "2002" }, value: { de: "Einf\u00fchrung des Euro als Bargeld in Deutschland", en: "Introduction of the Euro as cash currency in Germany" }, image: "/images/topics/wichtige-jahreszahlen/euro.jpg" },
