  ...
  // === Geschichte ===
  {
    ...
    details: {
      ...
      table: {
        ...
        rows: [
          { label: { de: "30. Jan. 1933", en: "Jan. 30, 1933" }, value: { de: "Adolf Hitler wird Reichskanzler", en: "Adolf Hitler becomes Chancellor" } },
          { label: { de: "9. Nov. 1938", en: "Nov. 9, 1938" }, value: { de: "\u201eReichspogromnacht\u201c: Zerst\u00f6rung von Synagogen und j\u00fcdischen Gesch\u00e4ften in ganz Deutschland", en: "\u201cReichskristallnacht\u201d: Destruction of synagogues and Jewish businesses throughout Germany" } },
          { label: { de: "1939\u20131945", en: "1939 to 1945" }, value: { de: "Der Zweite Weltkrieg", en: "World War II" } },
          { label: { de: "20. Juli 1944", en: "July 20, 1944" }, value: { de: "Gescheitertes Attentat auf Hitler. Claus Schenk Graf von Stauffenberg war beteiligt.", en: "Failed assassination attempt on Hitler. Claus Schenk Graf von Stauffenberg was involved." } },
          { label: { de: "27. Jan. 1945", en: "Jan. 27, 1945" }, value: { de: "Befreiung des Konzentrationslagers Auschwitz. Heute ist dieser Tag offizieller Gedenktag.", en: "Liberation of the Auschwitz concentration camp. Today is an official day of remembrance." } },
          { label: { de: "8. Mai 1945", en: "May 8, 1945" }, value: { de: "Ende des Zweiten Weltkriegs in Europa. Deutschland kapituliert bedingungslos.", en: "End of World War II in Europe. Germany surrenders unconditionally." } },
        ],
      },
      keyFacts: [
        { label: { de: "Staatsform", en: "Form of state" }, value: { de: "Diktatur (\u201eDrittes Reich\u201c / \u201eNS-Staat\u201c)", en: "Dictatorship (\u201cThird Reich\u201d / \u201cNazi State\u201d)" } },
        { label: { de: "Keine freien Wahlen", en: "No free elections" }, value: { de: "Pressezensur, willk\u00fcrliche Verhaftungen, keine Meinungsfreiheit", en: "Press censorship, arbitrary arrests, no freedom of expression" } },
        { label: { de: "Holocaust", en: "Holocaust" }, value: { de: "Systematische Verfolgung und Ermordung von 6 Millionen Juden und anderen Minderheiten", en: "Systematic persecution and murder of 6 million Jews and other minorities" } },
        { label: { de: "Gedenktag", en: "Day of remembrance" }, value: { de: "27. Januar \u2013 Befreiung von Auschwitz (offizieller Gedenktag)", en: "January 27 \u2013 Liberation of Auschwitz (official day of remembrance)" } },
        { label: { de: "Stolpersteine", en: "Stolpersteine" }, value: { de: "Gedenksteine in Gehwegen erinnern an Opfer des Nationalsozialismus", en: "Memorial stones in sidewalks commemorate victims of National Socialism" } },
      ],
    },
  },
  {
