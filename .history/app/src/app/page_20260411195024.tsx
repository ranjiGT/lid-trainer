      ...
      <main className="max-w-4xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 pb-16">
          ...
          <Link href="/topics" className="group">
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 p-8 border-2 border-transparent group-hover:border-amber-300 dark:group-hover:border-amber-600 h-full">
              <div className="text-5xl mb-6">📖</div>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">
                {t("topicsMode", lang)}
              </h2>
              ...
              <div className="mt-6 text-amber-600 dark:text-amber-400 font-semibold group-hover:translate-x-1 transition-transform inline-flex items-center gap-1">
                {t("startTopics", lang)} →
              </div>
            </div>
          </Link>
