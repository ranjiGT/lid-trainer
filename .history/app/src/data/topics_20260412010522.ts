    ...
    details: {
      ...
      table: {
        ...
        rows: [
          ...
          { label: { de: "8. Mai 1945", en: "May 8, 1945" }, value: { de: "Ende des Zweiten Weltkriegs in Europa (Kapitulation Deutschlands)", en: "End of World War II in Europe (Germany\u2019s surrender)" } },
          ...
          { label: { de: "7. Dez. 1970", en: "Dec. 7, 1970" }, value: { de: "Willy Brandts Kniefall in Warschau \u2013 Symbol der Vers\u00f6hnung (Ostpolitik)", en: "Willy Brandt\u2019s genuflection in Warsaw \u2013 symbol of reconciliation (Ostpolitik)" } },
