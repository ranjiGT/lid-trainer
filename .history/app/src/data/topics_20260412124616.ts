...
export const topics: Topic[] = [
  ...
  },
  {
    ...
    description: {
      de: "Ein Sch\u00f6ffe ist ein Laienrichter \u2013 kein Jurist, sondern ein einfacher B\u00fcrger. Sch\u00föffen arbeiten mit Berufsrichtern zusammen und entscheiden gemeinsam \u00fcber Schuld und Strafe.",
      en: "A Sch\u00föffe is a lay judge \u2013 not a lawyer, but an ordinary citizen. Lay judges work alongside professional judges and decide jointly on guilt and punishment.",
    },
    illustration: "\u2696\ufe0f",
    relatedQuestionNumbers: [140, 141, 150],
    details: {
      intro: {
        de: "Ein \u201eSch\u00föffe\u201c ist ein Laienrichter. Er oder sie ist kein Jurist, sondern ein einfacher B\u00fcrger. Sch\u00föffen arbeiten mit Berufsrichtern zusammen und entscheiden gemeinsam \u00fcber Schuld und Strafe.",
        en: "A \u201cSch\u00föffe\u201d is a lay judge. He or she is not a lawyer, but an ordinary citizen. Lay judges work alongside professional judges and decide jointly on guilt and punishment.",
      },
      keyFacts: {
        title: { de: "Wichtige Fakten", en: "Key Facts" },
        items: [
  ...
  },
  {
    ...
    details: {
      intro: {
        de: "1957 unterzeichneten in Rom sechs L\u00e4nder (Belgien, Deutschland, Frankreich, Italien, Luxemburg und die Niederlande) die R\u00fömischen Vertr\u00e4ge. Damit gr\u00fcndeten sie die Europ\u00e4ische Wirtschaftsgemeinschaft (EWG) und die Europ\u00e4ische Atomgemeinschaft (Euratom). Ziel war ein gemeinsamer Markt ohne Z\u00f6lle.",
      ...
      keyFacts: {
        title: { de: "Wichtige Fakten", en: "Key Facts" },
        items: [
          { fact: { de: "1957: Unterzeichnung der R\u00fömischen Vertr\u00e4ge", en: "1957: Signing of the Treaty of Rome" } },
    ...
    details: {
      ...
      table: {
        ...
        rows: [
          ...
          { label: { de: "1957", en: "1957" }, value: { de: "R\u00fömische Vertr\u00e4ge \u2013 Gr\u00fcndung der EWG (6 L\u00e4nder)", en: "Treaty of Rome \u2013 founding of the EEC (6 countries)" } },
          ...
          { label: { de: "2007", en: "2007" }, value: { de: "50-j\u00e4hriges Jubil\u00e4um der R\u00fömischen Vertr\u00e4ge", en: "50th anniversary of the Treaty of Rome" } },
        ],
      },
      keyFacts: {
